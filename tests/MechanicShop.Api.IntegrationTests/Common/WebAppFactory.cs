...
using Testcontainers.MsSql; // uses Docker
using Xunit;
...
{
    [Obsolete("Obsolete")] private readonly MsSqlContainer _dbContainer = new MsSqlBuilder().Build();
    ...
    {
        return _dbContainer.StartAsync().ContinueWith(async _ =>
        {
