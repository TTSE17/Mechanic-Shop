...
namespace MechanicShop.Application.SubcutaneousTests.Behaviours;
...
public class PerformanceBehaviourTests
{
    ...
    public PerformanceBehaviourTests()
    {
        ...
        _behaviour = new PerformanceBehaviour<TestRequest, TestResponse>(_logger, _user, _identityService);
    }
