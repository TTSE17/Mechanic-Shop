...
public class ServiceApi(IHttpClientFactory httpClientFactory, TimeZoneService timeZoneService)
{
    ...
    private async Task<ApiResult<CustomerModel>> GetCustomerAsync(Guid customerId)
    {
        try
        {
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            {
                var workOrders =
                    await response.Content.ReadFromJsonAsync<PaginatedList<WorkOrderListItemModel>>(
        ...
        {
            return await HandleExceptionAsync<PaginatedList<WorkOrderListItemModel>>(ex,
    ...
    public async Task<ApiResult> UpdateWorkOrderLaborAsync(Guid workOrderId, AssignLaborRequest laborUpdateRequest)
    {
        ...
        {
            var response =
                await _httpClient.PutAsJsonAsync($"api/v1/WorkOrders/{workOrderId}/labor", laborUpdateRequest);
    ...
    public async Task<ApiResult> UpdateWorkOrderStateAsync(Guid workOrderId,
        UpdateWorkOrderStateRequest statusUpdateRequest)
    {
        try
        {
            var response =
                await _httpClient.PutAsJsonAsync($"api/v1/WorkOrders/{workOrderId}/state", statusUpdateRequest);
    ...
    public async Task<ApiResult> UpdateWorkOrderRepairTasksAsync(Guid workOrderId,
        ModifyRepairTaskRequest updateWorkOrderRepairTasks)
    {
        try
        {
            var response = await _httpClient.PutAsJsonAsync($"api/v1/WorkOrders/{workOrderId}/repair-task",
    ...
    public async Task<ApiResult<List<VehicleModel>>> GetVehiclesByCustomerIdAsync(Guid customerId)
    {
        ...
        {
            return await HandleExceptionAsync<List<VehicleModel>>(ex,
                $"Failed to retrieve vehicles for customer {customerId}");
        }
    }
    ...
    public async Task<ApiResult<ScheduleModel>> GetDailySchedule(DateOnly date, Guid? laborId = null)
    {
        try
        {
            ...
            var tz = await timeZoneService.GetLocalTimeZoneAsync();
    ...
    public async Task<ApiResult<InvoiceModel>> IssueInvoiceAsync(Guid workorderId)
    {
        ...
        {
            return await HandleExceptionAsync<InvoiceModel>(ex,
                $"Failed to issue invoice for work order {workorderId}");
        }
    }
    ...
    public async Task<ApiResult<TodayWorkOrderStatsModel>> GetTodayWorkOrderStatsAsync(DateOnly? date = null)
    {
        ...
        {
            return await HandleExceptionAsync<TodayWorkOrderStatsModel>(ex,
                "Unexpected error occurred while fetching dashboard stats.");
        }
    }
    ...
    public async Task<ApiResult<RepairTaskModel>> UpdateRepairTaskAsync(Guid repairTaskId,
