...
{
    public async Task<Result<TodayWorkOrderStatsDto>> Handle(GetWorkOrderStatsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        return new TodayWorkOrderStatsDto
        {
            ...
            CompletionRate =
                total > 0 ? (decimal)stats.Count(x => x.State == WorkOrderState.Completed) / total * 100 : 0,
