            ...
            col.Item().PaddingTop(30).Row(row =>
            {
                ...
                row.RelativeItem(1).Column(totalsCol =>
                {
                    ...
                    totalsCol.Item().PaddingVertical(5).Row(totalRow =>
                    {
                        ...
                        totalRow.RelativeItem().AlignRight().Text($"{invoice.Subtotal:C}").FontSize(11)
                            .FontColor(Colors.Grey.Darken3);
                    });
                    ...
                    totalsCol.Item().PaddingVertical(5).Row(totalRow =>
                    {
                        ...
                        totalRow.RelativeItem().AlignRight().Text($"{invoice.TaxAmount:C}").FontSize(11)
                            .FontColor(Colors.Grey.Darken3);
                    });
                    ...
                    if (invoice.DiscountAmount > 0)
                    {
                        totalsCol.Item().PaddingVertical(5).Row(totalRow =>
                        {
                            ...
                            totalRow.RelativeItem().AlignRight().Text($"-{invoice.DiscountAmount:C}").FontSize(11)
                    ...
                    totalsCol.Item()
                        ...
                        .Row(totalRow =>
                        {
                            ...
                            totalRow.RelativeItem().AlignRight().Text($"{invoice.Total:C}").FontSize(16).Bold()
